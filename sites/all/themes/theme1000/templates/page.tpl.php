...
<?php if ( !theme_get_setting( 'theme1000_breadcrumb_show' ) ) :
	$breadcrumb = NULL;
endif; ?>
...
<div id="page-wrapper" class="page-wrapper">
	<div id="page" class="page">
		...
		<header id="header" class="header page-header clearfix" role="banner">
			...
			<div class="<?php if ( theme_get_setting( 'theme1000_sticky_menu' ) ) { echo 'stickup '; } ?>header-section-1"> <!-- Sticky menu wrapper -->
				<div class="container-12">
					<div class="grid-12">
						<div class="col1">
							<!-- Logo -->
			...
			<!-- Region Header -->
			<?php if ( $page['header'] ) : 
				theme1000_region_preffix ( 'header' );
					print render( $page['header'] );
				theme1000_region_suffix ( 'header' );
			endif; ?>

			<!-- Region Header bottom -->
			<?php if ( $page['header_bottom'] ) : 
				theme1000_region_preffix ( 'header_bottom' );
					print render( $page['header_bottom'] );
				theme1000_region_suffix ( 'header_bottom' );
			endif; ?>
		</header>
		...
		<div id="main-wrapper" class="main-wrapper" role="main">
			...
			<?php if ( $page['content_top'] ) : 
				theme1000_region_preffix ( 'content_top' );
					print render( $page['content_top'] );
				theme1000_region_suffix ( 'content_top' );
			endif; ?>
			
			<!-- Region Parallax one -->
			<?php if ( $page['parallax_one'] ) : 
				theme1000_region_preffix ( 'parallax_one' );
					print render( $page['parallax_one'] );
				theme1000_region_suffix ( 'parallax_one' );
			endif; ?>
			
			<!-- Region Parallax three -->
			<?php if ( $page['parallax_three'] ) : 
				theme1000_region_preffix ( 'parallax_three' );
					print render( $page['parallax_three'] );
				theme1000_region_suffix ( 'parallax_three' );
			endif; ?>
			
			<!-- Region Parallax four -->
			<?php if ( $page['parallax_four'] ) : 
				theme1000_region_preffix ( 'parallax_four' );
					print render( $page['parallax_four'] );
				theme1000_region_suffix ( 'parallax_four' );
			endif; ?>
			...
			<?php if ( $page['parallax_two'] ) : 
				theme1000_region_preffix ( 'parallax_two' );
					print render( $page['parallax_two'] );
				theme1000_region_suffix ( 'parallax_two' );
			endif; ?>

			<!-- Region Parallax five -->
			<?php if ( $page['parallax_five'] ) : 
				theme1000_region_preffix ( 'parallax_five' );
					print render( $page['parallax_five'] );
				theme1000_region_suffix ( 'parallax_five' );
			endif; ?>

			<!-- Region Section One -->
			<?php if ( $page['section_one'] ) : 
				theme1000_region_preffix ( 'section_one' );
					print render( $page['section_one'] );
				theme1000_region_suffix ( 'section_one' );
			endif; ?>

			<!-- Region Content bottom -->
			<?php if ( $page['content_bottom'] ) : 
				theme1000_region_preffix ( 'content_bottom' );
					print render( $page['content_bottom'] );
				theme1000_region_suffix ( 'content_bottom' );
			endif; ?>
		</div>
		...
		<footer id="footer" class="footer page-footer" role="contentinfo">
			...
			<?php if ( $page['footer_top'] ) : 
				theme1000_region_preffix ( 'footer_top' );
					print render( $page['footer_top'] );
				theme1000_region_suffix ( 'footer_top' );
			endif; ?>
			...
			<div class="footer-wrapper">
				<div class="container-12">
					<div class="grid-12 clearfix">
						...
						<?php if ( $is_front ) : ?>
							 Página hecha por <a rel="nofollow" href="https://www.facebook.com/jesus.estrada.756" target="_blank">Jesús Estrada</a>
						<?php endif; ?>
					</div>
				</div>
			</div>
